...
(lib.PICsroll = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-150,-154);
	...
	this.instance_1.setTransform(-150,-154);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).to({_off:true},1).wait(1));

	// Layer_10
	this.instance_2 = new lib.Layer10();
	this.instance_2.setTransform(-150,-154);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).to({_off:true},1).wait(2));

	// Layer_9
	this.instance_3 = new lib.Layer9();
	this.instance_3.setTransform(-150,-154);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},1).wait(3));

	// Layer_8
	this.instance_4 = new lib.Layer8();
	this.instance_4.setTransform(-150,-154);
	...
	this.instance_5.setTransform(-150,-154);
	...
	this.instance_6.setTransform(-150,-154);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({_off:true},1).wait(6));

	// Layer_5
	this.instance_7 = new lib.Layer5();
	this.instance_7.setTransform(-150,-154);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(3).to({_off:false},0).to({_off:true},1).wait(7));

	// Layer_4
	this.instance_8 = new lib.Layer4();
	this.instance_8.setTransform(-150,-154);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({_off:false},0).to({_off:true},1).wait(8));

	// Layer_3
	this.instance_9 = new lib.Layer3();
	this.instance_9.setTransform(-150,-154);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({_off:false},0).to({_off:true},1).wait(9));

	// Layer_2
	this.instance_10 = new lib.Layer2();
	this.instance_10.setTransform(-150,-154);
...
p.nominalBounds = new cjs.Rectangle(-150,-154,300,307);
...
if (reversed == null) { reversed = false; }
	...
	// PICs_roll
	this.instance_1 = new lib.PICsroll();
	this.instance_1.setTransform(150,245);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(75).to({_off:false},0).to({_off:true},11).wait(5));
	...
	this.shape_28.graphics.f("#FFFFFF").s().p("");
	this.shape_28.setTransform(249.55,462.475);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AA4BSIAAh8IgBAAIgqB8IgaAAIgqh8IAAAAIAAB8IgkAAIAAijIA2AAIAlBqIAAAAIAmhqIA2AAIAACjg");
	this.shape_29.setTransform(232,462.6);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AAtBSIgOgjIg+AAIgOAjIgnAAIBGijIAdAAIBGCjgAATAQIgTgxIgUAxIAnAAg");
	this.shape_30.setTransform(212.675,462.6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("Ag4BSIAAijIBtAAIAAAiIhJAAIAAAeIBFAAIAAAgIhFAAIAAAiIBNAAIAAAhg");
	this.shape_31.setTransform(197.225,462.6);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("AAWBSIghhCIgRAAIAABCIgkAAIAAijIA/AAQALAAALADQAMADAIAFQAIAGAFAJQAFAKAAAOQAAASgJALQgJALgRAEIApBFgAgcgNIAVAAIAJAAQAGAAAEgCQAEgCADgEQADgEAAgGQAAgGgDgEQgCgEgEgCIgJgCIgJgBIgXAAg");
	this.shape_32.setTransform(182.975,462.6);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AgRBSIAAiDIgvAAIAAggICBAAIAAAgIgvAAIAACDg");
	this.shape_33.setTransform(168.2,462.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFFFFF").s().p("");
	this.shape_34.setTransform(154.725,462.6);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("");
	this.shape_35.setTransform(132.075,462.6);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AgRBSIAAiDIgvAAIAAggICAAAIAAAgIguAAIAACDg");
	this.shape_36.setTransform(115.9,462.6);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFFFF").s().p("AAkBSIgkhxIAAAAIgjBxIgfAAIgwijIAmAAIAaBoIABAAIAihoIAhAAIAhBrIABAAIAbhrIAkAAIgvCjg");
	this.shape_37.setTransform(91,462.6);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FFFFFF").s().p("Ag4BSIAAijIBtAAIAAAiIhJAAIAAAeIBFAAIAAAgIhFAAIAAAiIBNAAIAAAhg");
	this.shape_38.setTransform(72.575,462.6);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#FFFFFF").s().p("AAeBSIhGhzIAAAAIAABzIgkAAIAAijIAxAAIBEBxIAAAAIAAhxIAkAAIAACjg");
	this.shape_39.setTransform(55.725,462.6);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#FFFFFF").s().p("AgZBQQgPgHgNgKQgLgMgHgPQgGgQAAgUQAAgSAGgQQAHgQALgLQANgMAPgFQARgGARgBQAUAAAQAFQARAFAMAMIgZAbQgHgHgJgFQgKgEgOAAQgKAAgJAEQgJAFgHAHQgHAGgDAKQgEAKAAAKQAAALAEAKQADAJAHAHQAHAHAJAEQAJAFAKAAQAMAAAJgDIAOgFIAAgbIgdAAIAAggIA/AAIAABUQgQAIgRAEQgSAEgSgBQgRAAgRgFg");
	this.shape_40.setTransform(248.9,433.2);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#FFFFFF").s().p("AAeBSIhGh0IAAAAIAAB0IgkAAIAAiiIAxAAIBEBwIAAAAIAAhwIAkAAIAACig");
	this.shape_41.setTransform(230.975,433.2);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#FFFFFF").s().p("AgRBSIAAiiIAjAAIAACig");
	this.shape_42.setTransform(218.2,433.2);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#FFFFFF").s().p("AAjBSIAAhHIhFAAIAABHIgkAAIAAiiIAkAAIAAA9IBFAAIAAg9IAkAAIAACig");
	this.shape_43.setTransform(206.075,433.2);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#FFFFFF").s().p("AgRBSIAAiDIguAAIAAgfIB/AAIAAAfIguAAIAACDg");
	this.shape_44.setTransform(190.75,433.2);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#FFFFFF").s().p("Ag4BSIAAiiIBtAAIAAAhIhJAAIAAAeIBFAAIAAAgIhFAAIAAAhIBNAAIAAAig");
	this.shape_45.setTransform(177.225,433.2);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#FFFFFF").s().p("AA4BSIAAh8IAAAAIgrB8IgaAAIgqh8IAAAAIAAB8IgkAAIAAiiIA2AAIAlBpIABAAIAlhpIA2AAIAACig");
	this.shape_46.setTransform(158.85,433.2);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#FFFFFF").s().p("");
	this.shape_47.setTransform(138.475,433.2);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#FFFFFF").s().p("");
	this.shape_48.setTransform(122.025,433.2);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#FFFFFF").s().p("AhKBSIAAiiIA2AAQATgBARAFQARAFANAJQAOAKAHAQQAIAPAAAWQAAATgIAQQgHAPgNAKQgMAKgRAFQgQAFgSABgAgmAwIASAAQANABAJgDQALgDAIgGQAIgGAEgJQAFgJAAgNQAAgMgFgJQgEgJgIgGQgHgFgLgDQgJgDgLAAIgVAAg");
	this.shape_49.setTransform(100.625,433.2);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#FFFFFF").s().p("Ag4BSIAAiiIBtAAIAAAhIhJAAIAAAeIBFAAIAAAgIhFAAIAAAhIBNAAIAAAig");
	this.shape_50.setTransform(84.525,433.2);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#FFFFFF").s().p("Ag4BSIAAiiIBtAAIAAAhIhJAAIAAAeIBFAAIAAAgIhFAAIAAAhIBNAAIAAAig");
	this.shape_51.setTransform(70.075,433.2);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#FFFFFF").s().p("AAeBSIhGh0IAAAAIAAB0IgkAAIAAiiIAxAAIBEBwIAAAAIAAhwIAkAAIAACig");
	this.shape_52.setTransform(53.225,433.2);
	...
	// VStv_logo
	this.instance_3 = new lib._300x600VStvlogo();

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(91));

	// BKGD
	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#000000").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	this.shape_53.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.shape_53).wait(91));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/VS_SODOmotive_300x600_atlas_P_1.png?1682102925865", id:"VS_SODOmotive_300x600_atlas_P_1"},
		{src:"images/VS_SODOmotive_300x600_atlas_NP_1.jpg?1682102925866", id:"VS_SODOmotive_300x600_atlas_NP_1"}
	],
	preloads: []
};
